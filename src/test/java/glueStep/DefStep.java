...
public class DefStep 
{
	...
	public class StepDef
	{
		...
		@When("Team executive provides {string} and {string} as credentials")
		...
		@Then("Team provides {string} , {string} , {string} , {string}")
		...
		@Then("Team continues to provides {string} , {string} , {string} , {string} , {string} , {string} , {string}")
		...
		@When("Team verifies the product availability")
